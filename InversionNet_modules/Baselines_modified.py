...
class InversionNet(nn.Module):
    def __init__(self, dim1=64, dim2=128, dim3=256, dim4=512, dim5=1024, sample_spatial=1.0, **kwargs):
        ...
        # 解码器
        self.decoder7 = UNetDecoderBlock(dim5, dim4) # 1 * 1 -> 2 * 2
        self.decoder6 = UNetDecoderBlock(dim4, dim3) # 2 * 16 -> 32 * 32
        self.decoder5 = UNetDecoderBlock(dim3, dim2) # 32 * 32 -> 64 * 64
        self.decoder4 = UNetDecoderBlock(dim2, dim1) # 64 * 64 -> 128 * 128
        self.decoder3 = UNetDecoderBlock(dim1, 32) # 64 * 64 -> 128 * 128
